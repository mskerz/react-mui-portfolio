...
import { SiFastapi, SiFlutter, SiDocker, SiMysql, SiPhp, SiPython } from 'react-icons/si';
import { FlutterIcon, AngularIcon, SlimIcon, MySqlIcon, PythonIcon } from '../assets/Icon';
...
const skillIcons = {
    ...
    FastAPI: <SiFastapi color="#04988A" size={40} />,
